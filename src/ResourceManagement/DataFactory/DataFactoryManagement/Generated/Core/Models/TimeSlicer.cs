...
namespace Microsoft.Azure.Management.DataFactories.Core.Models
{
    ...
    /// </summary>
    public partial class TimeSlicer : Slicer
    {
        ...
        /// <summary>
        /// Initializes a new instance of the TimeSlicer class with required
        /// arguments.
        /// </summary>
        public TimeSlicer(string frequency, uint interval, string name)
            : this()
        {
            if (frequency == null)
            {
